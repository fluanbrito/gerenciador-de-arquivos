...
def organizar(diretorio):
    for arquivos in os.listdir(diretorio):   #Metodo de listar arquivos de um diretorio
        ...
        try:                        
            ...
            extensao = '7423YSISTEMASOPERACIONAISASUQAFA'
            pass
        if extensao in arquivos:                       #Se a extensao existe, ela irá mover o arquivo para pasta correspondete        
            try:#
...
def moverArquivo(localdoArquivo, voltar): #Função de mover o item para o referido diretório
